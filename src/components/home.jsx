        ...
        <div className="Home">
            <div className="hero d-flex justify-content-center">
                ...
                <div className="infoSection col-4">
                    ...
                    <button className="btn col-12 border heroBtn fw-bold fs-4 rounded-0 btn-secondary" style={{ height: "70px", padding: "20px" }}>Read more &gt;</button>
                </div>
            </div>
            <div className="contents_section my-5">
                ...
                <div className="contents d-flex">
                    ...
                    <div className="mainPost col-5">
                        <img src="/images/food6.jpeg" className="rounded-2" width="620" height="700" alt="" />
                    </div>
                </div>
            </div>
        </div>
